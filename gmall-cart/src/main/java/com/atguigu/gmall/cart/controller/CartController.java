...
public class CartController {
    ...
    public String test(HttpServletRequest request) throws ExecutionException, InterruptedException {
        ...
        System.out.println("controller方法开始执行了=======+++++++");
...
//            System.out.println("executor1执行成功" + result);
//        },ex -> {
//            System.out.println("executor1执行失败" + ex.getMessage());
//
//        });
//        future2.addCallback(result -> {
//            System.out.println("executor2执行成功" + result);
//        },ex -> {
//            System.out.println("executor2执行失败" + ex.getMessage());
//
//        });
        System.out.println("controller方法执行结束了=======+++++++"+ (System.currentTimeMillis() - now));
